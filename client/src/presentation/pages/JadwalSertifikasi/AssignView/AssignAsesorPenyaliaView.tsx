...
import DeleteAssignAsesorPenyeliaModal from '../../../components/Fragments/Asesmen/Asesor/DeleteAssignAsesorPenyeliaModal';
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <div className='flex flex-row items-center gap-4'>
                    ...
                    <DeleteAssignAsesorPenyeliaModal id={row.original.id} />
                </div>
            ),
        },
    ];
