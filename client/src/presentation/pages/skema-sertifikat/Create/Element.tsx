...
import { ElementStructure, UnitKompetensiStructure } from "../../../../data/models/SkemaDao";
...
const UnitKompetensi: React.FC = () => {
  ...
  const { errors, touched, values, handleSubmit, setValues } = useFormik<ElementStructure[]>({
    initialValues: [
      {
        unitKompetensi: "",
        namaElement: "",
  ...
  const handleValues = <T extends keyof ElementStructure>(
    index: number,
    name: T,
    value: ElementStructure[T]
  ) => {
                ...
                <div className="flex flex-col w-full gap-6 lg:gap-16 lg:grid lg:grid-cols-3 lg:gap-y-10 items-center">
                  <div className="flex flex-col gap-3">
                    ...
                    <ComboBox
                      ...
                      value={value.unitKompetensi}
                      placeholder="Pilih Skema"
                      onChange={(e) => handleValues(index, "unitKompetensi", e.target.value)}
                    />
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Input
                      type="text"
                      name="namaElement"
                      value={value.namaElement}
                      onChange={(e) => handleValues(index, "namaElement", e.target.value)}
                    />
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-row items-center">
                      <Input
                        type="text"
                        name="nomorElement"
                        value={value.nomorElement}
                        onChange={(e) =>
                          handleValues(index, "nomorElement", parseInt(e.target.value))
                        }
                      />
