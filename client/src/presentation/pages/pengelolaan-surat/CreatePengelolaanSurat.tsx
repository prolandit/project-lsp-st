...
import { CreatePengelolaanSuratValues } from "../../../common/types";
...
const CreatePengelolaanSurat = () => {
  const onCreatePengelolaanSurat = async (
    pengelolaanSurat: CreatePengelolaanSuratValues
  ) => {
...
export default CreatePengelolaanSurat;
