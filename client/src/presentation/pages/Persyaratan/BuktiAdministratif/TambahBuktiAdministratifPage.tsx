...
import { buktiAdministratifInputSchema } from '../../../../common/formSchemas';
...
const TambahBuktiAdministratifPage = () => {
    // const [isLoading, setIsLoading] = useState(false);

    const onSave = async (payload: AdministrativeEvidenceValues) => {
        console.log(payload);
        // setIsLoading(true);
    ...
    const { errors, touched, handleChange, handleSubmit, setFieldValue } =
        useFormik({
            ...
            validationSchema: buktiAdministratifInputSchema,
            onSubmit: onSave,
        });
...
export default TambahBuktiAdministratifPage;
