...
import { persyaratanPendaftaranInputSchema } from '../../../../common/formSchemas';
...
const TambahPersyaratanPendaftaranPage = () => {
    ...
    const onSave = async (payload: RegistrationRequirementValues) => {
        console.log(payload);
        // setIsLoading(true);
    ...
    const {
        ...
        validationSchema: persyaratanPendaftaranInputSchema,
        onSubmit: onSave,
    });
...
export default TambahPersyaratanPendaftaranPage;
