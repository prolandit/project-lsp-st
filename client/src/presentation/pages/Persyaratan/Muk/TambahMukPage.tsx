...
import { mukInputSchema } from '../../../../common/formSchemas';
import { MukValues } from '../../../../common/types';
...
const TambahMukPage = () => {
    ...
    const onSave = async (payload: MukValues) => {
        console.log(payload);
        // setIsLoading(true);
    ...
    const {
        ...
        validationSchema: mukInputSchema,
        onSubmit: onSave,
    });
                    ...
                    <div className='w-full pt-4 bg-white rounded-md shadow-sm pb-7 drop-shadow-sm'>
                        ...
                        <div className='flex flex-col gap-6 px-4 lg:gap-8 lg:px-6'>
                            <div className='flex flex-col w-full gap-6 lg:grid lg:grid-cols-3'>
                                ...
                                <div className='flex flex-col w-full gap-3'>
                                    <Label htmlFor='methodId'>Metode Uji</Label>
                                    <ComboBox
                                        name='methodId'
                                        items={[]}
                                        value={''}
                                        ...
                                        className='w-full'
                                    />
                                    {errors.methodId && touched.methodId ? (
                                        <Alert
                                            message={errors.methodId}
                                            type='error'
                                        />
                                    ) : null}
                                </div>
