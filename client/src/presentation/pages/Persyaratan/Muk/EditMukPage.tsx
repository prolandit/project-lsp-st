...
import { mukEditSchema } from '../../../../common/formSchemas';
...
const EditMukPage = () => {
    ...
    const onEdit = async (payload: MukValues) => {
        console.log(payload);
        // setIsLoading(true);
    ...
    const {
        ...
        validationSchema: mukEditSchema,
        onSubmit: onEdit,
    });
