...
import { PengajuanSkemaPersyaratanDasarStructure } from "../../../data/models/PengajuanSkemaDao";
...
const DummyData = (): PengajuanSkemaPersyaratanDasarStructure => {
  return {
    id: faker.number.int(),
...
const PengajuanSkemaPersyaratanDasar: React.FC = () => {
  const [data, setData] = useState<PengajuanSkemaPersyaratanDasarStructure[]>(
    []
  );
  ...
  const columns: ColumnDef<PengajuanSkemaPersyaratanDasarStructure>[] = [
    {
...
export default PengajuanSkemaPersyaratanDasar;
