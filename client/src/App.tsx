...
import RenderRouter from "./presentation/router/router";

const App = () => {
  return (
    <BrowserRouter basename="/">
      {/* adding configurable route */}
      <RenderRouter />
      <Routes>
        <Route path="/" element={<MainLayout />}>
          <Route index key="index" element={<BerandaLayout />} />
          <Route key="profile" path="/profile" element={<ProfilePage />} />
          <Route key="users" path="/users" element={<UsersPage />} />
          <Route key="create-user" path="/users/create" element={<CreateUserPage />} />
          <Route key="edit-user" path="/users/edit/:id" element={<EditUserPage />} />
        </Route>
        <Route key="login" path="/login" element={<LoginPage />} />
        <Route key="register" path="/register" element={<RegisterPage />} />
        <Route key="ubah-password" path="/ubah-password" element={<ChangePasswordPage />} />
        <Route key="error" path="*" element={<NotFoundPage />} />
      </Routes>
    </BrowserRouter>
  );
};
